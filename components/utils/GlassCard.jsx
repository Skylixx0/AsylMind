...
export const GlassCard = ({ index, question, answer }) => {
  ...
  <div       
    ...
    className=" sm:w-[100%] max-w-lg relative group bg-white/10 border border-white/90 rounded-xl  overflow-hidden backdrop-blur-md shadow-md hover:shadow-2xl transition-all mx-auto duration-500 w-full h-45 md:h-55 lg:h-60">
    {/* Front: Question */}
    ...
    <div className={`absolute inset-0 flex items-center justify-center px-4 text-sm md:text-md lg:text-lg leading-relaxed text-black text-center font-bold bg-white/50 transition-all duration-500
